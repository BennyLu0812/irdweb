...
public class SchCtrlLogEntity extends AbstractEntity {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "IRD_SCH_CTRL_LOG_SEQ")
    @SequenceGenerator(name = "IRD_SCH_CTRL_LOG_SEQ", sequenceName = "IRD_SCH_CTRL_LOG_SEQ", allocationSize = 1)
