...
public class UserEntity extends AbstractEntity implements Comparable<UserEntity>{
    ...
    @Column(name="USER_NAME_PT", columnDefinition = "VARCHAR2(64 CHAR)")
	...
	@JoinTable(name = "IRD_SYS_USER_ROLE", joinColumns = { @JoinColumn(name = "USER_ID", referencedColumnName = "USER_ID") },
