 ...
 * @author Tim
 * @version 1.0
 * @date 25/01/2022 16:33
 */
@ColumnWidth(30)
public class InspectionDataStatisticsPO {
    ...
    public String getEoerallResult() {
        return eoerallResult;
    }

    public void setEoerallResult(String eoerallResult) {
        this.eoerallResult = eoerallResult;
    }
    ...
    public String toString() {
        return "InspectionDataStatisticsPO{" +
