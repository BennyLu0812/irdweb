 ...
 * @author Tim
 * @version 1.0
 * @date 26/01/2022 10:28
 */
public class InspectionItemStatisticsDTO extends ReportExportBaseDTO{
     ...
     * H(行車制動 (儀器))合格數
     */
    private Integer hhPassCount;

    /**
     * H(行車制動 (儀器))不合格數
     */
    private Integer hhNoPassCount;
    ...
    public Integer getHhPassCount() {
        return hhPassCount;
    }

    public void setHhPassCount(Integer hhPassCount) {
        this.hhPassCount = hhPassCount;
    }

    public Integer getHhNoPassCount() {
        return hhNoPassCount;
    }

    public void setHhNoPassCount(Integer hhNoPassCount) {
        this.hhNoPassCount = hhNoPassCount;
    }
    ...
    public String toString() {
        return "InspectionItemStatisticsDTO{" +
                ...
                ", hhCount=" + hhCount +
                ", hhPassCount=" + hhPassCount +
                ", hhNoPassCount=" + hhNoPassCount +
