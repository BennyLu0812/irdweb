    ...
    function($, Vue, atosBaseController, moment, momentConfig, atosUtil, axios, tinyImgUpload) {
        ...
        var controller = atosBaseController(momentConfig, {
            ...
            initVue: function() {
                var self = this;
                this.vue = new Vue({
                    el: '#alertBlackoutAPICancelRequestApp',
                    data: {
                        dataCentreId: '',
                        cancleReason: '',
                        blackoutWindowBegin: '',
                        ...
                        apiName:'alertBlackoutAPICancelRequest'
                    },
                    methods: {
                        doSubmit: function() {
                            var self = this;
                            if (!$.formValidator('#alertBlackoutAPICancelRequestForm')) { // 驗證
                                return false;
                            }

                            var requestDTO = JSON.stringify($('#alertBlackoutAPICancelRequestForm').serializeObject());
            ...
            vaildate: function() {
                var that = this;
                $("#alertBlackoutAPICancelRequestForm").bootstrapValidator({
                    fields: {
                        dataCentreId: {
                            validators: {
                                notEmpty: {
