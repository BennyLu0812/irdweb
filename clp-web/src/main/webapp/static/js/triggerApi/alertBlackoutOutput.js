    ...
    function($, Vue, atosBaseController, moment, momentConfig, atosUtil, axios, tinyImgUpload) {
        ...
        var controller = atosBaseController(momentConfig, {
            ...
            initEvent: function() {
                ...
                $('#output-blackoutWindowBegin').datetimepicker({
                    //language:  'cn',
                    ...
                    var starttime = $("#output-blackoutWindowBegin").val();
                    $("#output-blackoutWindowEnd").datetimepicker('setStartDate', starttime);
                    $("#output-blackoutWindowBegin").datetimepicker('hide');
                });

                $('#output-blackoutWindowEnd').datetimepicker({
                    //language:  'cn',
                    //minView: "month",//设置只显示到月份
                    startDate: sysDate,
                    ...
                    var endtime = $("#output-blackoutWindowEnd").val();
                    $("#output-blackoutWindowBegin").datetimepicker('setEndDate', endtime);
                    $("#output-blackoutWindowEnd").datetimepicker('hide');
                });
