...
public class AuditEnqEntity implements  Serializable {
    ...
    private String qIdentFullNamePt;
    ...
    @Column(name = "Q_IDENT_FULL_NAME_PT", columnDefinition = "VARCHAR2(200 CHAR)")
    public String getqIdentFullNamePt() {
        return qIdentFullNamePt;
    }

    public void setqIdentFullNamePt(String qIdentFullNamePt) {
        this.qIdentFullNamePt = qIdentFullNamePt;
    }
