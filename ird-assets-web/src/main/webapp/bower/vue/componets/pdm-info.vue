				...
				<div class="col-sm-12" v-show="titleshow">
	  			...
	  			<div v-if="hideIdentityDetail">
					<div class="form-group">
						...
						<div class="col-sm-1_5"><span class="text-readonly" v-text="personalProfile.cName"></span></div><label class="control-label col-sm-1">葡文名</label>
						<div class="col-sm-5_5"><span class="text-readonly" v-text="personalProfile.ptName"></span></div>
	  			...
	  			<div v-else>
					<div class="form-group">
						<label class="control-label col-sm-1" v-text="label.cName">中文名</label>
						<div class="col-sm-1_5"><span class="text-readonly" v-text="personalProfile.cName"></span></div><label class="control-label col-sm-1">葡文名</label>
						<div class="col-sm-5_5"><span class="text-readonly" v-text="personalProfile.ptName"></span></div><label class="control-label col-sm-1" v-text="label.birthDate">出生日期</label>
	...
	var pdmInfo = Vue.extend({
		    ...
		    methods:{
		    	initData:function(){
		    		...
		    		this.label.ptName= atosUtil.getI18nMessage('global.fullNamePT');
