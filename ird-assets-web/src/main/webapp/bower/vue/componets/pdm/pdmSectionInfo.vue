<template>
  <div v-show="show">
                <div class="form-group">
                    ...
                    <label class="control-label col-sm-1" v-text="label.namePT"></label>
                    <div class="col-sm-5_5"><span class="text-readonly" v-text="license.identFullNamePt"></span></div>
         ...
         props: {
            ...
            methods:{
                initData:function(){
                    ...
                    this.label.namePT= atosUtil.getI18nMessage('license.namePT');
