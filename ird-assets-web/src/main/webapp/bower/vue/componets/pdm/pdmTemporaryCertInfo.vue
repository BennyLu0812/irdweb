<template>
    <form class="form-horizontal row-sm margin-top-10" id="fm-ident">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-4">
                <div class="input-group">
                    <input @blur="nameBlur('identLastNamePt')" data-bv-stringlength="false" v-model="pdmCautionCertInfoList.identLastNamePt" v-bind:maxlength="pdmnameparammap['dlsPdmIdLastNamePtLen']" class="form-control" type="text" :placeholder="pdmI18NList.identLastNamePt" name="identName" id="identLastNamePt">
                    <span class="input-group-addon">/</span>
                    <input @blur="nameBlur('identFirstNamePt')" style="border-top-right-radius:4px;border-bottom-right-radius:4px" data-bv-stringlength="false" v-model="pdmCautionCertInfoList.identFirstNamePt" v-bind:maxlength="pdmnameparammap['dlsPdmIdFirstNamePtLen']" class="form-control" type="text" :placeholder="pdmI18NList.identFirstNamePt" name="identName" id="identFirstNamePt">
                </div>
            </div>
            <label class="control-label col-sm-1_5" th:text="#{pdm.identFullNamePt}">證件葡文全名 </label>
            <div class="col-sm-4">
                <input @blur="nameBlur('identFullNamePt')" data-bv-stringlength="false" v-model="pdmCautionCertInfoList.identFullNamePt" v-bind:maxlength="pdmnameparammap['dlsPdmIdFullNamePtLen']" id="identFullNamePt" class="form-control" type="text" name="identName" :placeholder="pdmI18NList.identFullNamePt">
            </div>
        </div>
...
define(['jquery','Vue','atosUtil','vueloader','select2','select2.config','datetimepicker.config'],function($,Vue,atosUtil){
	var pdmTemporaryCertInfo = Vue.extend({
		...
		methods:{
                ...
                // console.log(dlsPdmIdFullNamePtLen)
                // console.log(dlsPdmPrFullNameCnLen)
                // console.log(dlsPdmPrFullNamePtLen)
                ...
                if(nameId=='identLastNamePt'){
                    ...
                    $('#identLastNamePt').val(this.pdmCautionCertInfoList.identLastNamePt);//用于触发校验
                    let length = this.pdmCautionCertInfoList.identLastNamePt.length;
                    if(useValidator){
                ...
                if(nameId=='identFirstNamePt'){
                    ...
                    $('#identFirstNamePt').val(this.pdmCautionCertInfoList.identFirstNamePt);//用于触发校验
                    let length = this.pdmCautionCertInfoList.identFirstNamePt.length;
                    if(useValidator){
                        if(length>=dlsPdmIdColorChangePt){
                ...
                if(nameId=='identLastNamePt'||nameId=='identFirstNamePt'){
                    ...
                    if(atosUtil.isNotEmpty(this.pdmCautionCertInfoList.identLastNamePt)){
                        lastNameLength = this.pdmCautionCertInfoList.identLastNamePt.trim().length;
                        length += this.pdmCautionCertInfoList.identLastNamePt.trim().length;
                    }

                    if(atosUtil.isNotEmpty(this.pdmCautionCertInfoList.identFirstNamePt)){
                        firstNameLength = this.pdmCautionCertInfoList.identFirstNamePt.trim().length;
                        length += this.pdmCautionCertInfoList.identFirstNamePt.trim().length;
                    }
                    ...
                    if(length>0&&length<=dlsPdmIdFullNamePtLen){
                        ...
                        if(lastNameLength>0&&firstNameLength==0){
                            this.pdmCautionCertInfoList.identFullNamePt = this.pdmCautionCertInfoList.identLastNamePt.trim();
                        }

                        if(lastNameLength==0&&firstNameLength>0){
                            this.pdmCautionCertInfoList.identFullNamePt = this.pdmCautionCertInfoList.identFirstNamePt.trim();
                        }
                    ...
                    $('#identFullNamePt').val(this.pdmCautionCertInfoList.identFullNamePt);//用于触发校验
                ...
                if(nameId=='identFullNamePt'){
                    ...
                    $('#identFullNamePt').val(this.pdmCautionCertInfoList.identFullNamePt);//用于触发校验
                    let length = this.pdmCautionCertInfoList.identFullNamePt.length;
                    if(useValidator){
                        if(length>=dlsPdmIdColorChangePt){
                            $('#identFullNamePt').css('border-color','orange');
                        }else{
    		...
    		initEvent:function(){
                ...
                //列印葡文姓名改变
                $('#printLastNamePt,#printFirstNamePt').on('input',function(){
                    if($('#printLastNamePt').val().length == 0){
                        $('#printFullNamePt').val($("#printLastNamePt").val()+""+$("#printFirstNamePt").val());
                        self.pdmCautionCertInfoList.printFullNamePt = $("#printLastNamePt").val()+""+$("#printFirstNamePt").val();
                    }else{
                        $('#printFullNamePt').val($("#printLastNamePt").val()+" "+$("#printFirstNamePt").val());
                        self.pdmCautionCertInfoList.printFullNamePt = $("#printLastNamePt").val()+" "+$("#printFirstNamePt").val();
                    }
