<template>
     <form class="form-horizontal row-sm margin-top-10" id="fm-ident">
        ...
        <div class="form-group">
            <label class="control-label col-sm-1_5" v-text="pdmI18NList.identLastNamePtAndFirstNamePt">證件葡文姓/名 -t</label>
            <div class="col-sm-4">
                <div class="input-group">
                    <input @input="nameBlur('identLastNamePt')" @blur="nameBlur('identLastNamePt',true)" data-bv-stringlength="false" name="identName" v-bind:maxlength="pdmnameparammap['dlsPdmIdLastNamePtLen']" v-model="pdmCertInfoList.identLastNamePt" class="form-control" type="text" :placeholder="pdmI18NList.identLastNamePt" id="identLastNamePt">
                    <span class="input-group-addon">/</span>
                    <input @input="nameBlur('identFirstNamePt')" @blur="nameBlur('identFirstNamePt',true)" style="border-top-right-radius:4px;border-bottom-right-radius:4px" data-bv-stringlength="false" name="identName" v-bind:maxlength="pdmnameparammap['dlsPdmIdFirstNamePtLen']" v-model="pdmCertInfoList.identFirstNamePt" class="form-control" type="text" :placeholder="pdmI18NList.identFirstNamePt" id="identFirstNamePt">
                </div>
            </div>
            <label class="control-label col-sm-1_5" v-text="pdmI18NList.identFullNamePt">證件葡文全名-t </label>
            <div class="col-sm-4">
                <input @input="nameBlur('identFullNamePt')" @blur="nameBlur('identFullNamePt',true)" data-bv-stringlength="false" name="identName" v-bind:maxlength="pdmnameparammap['dlsPdmIdFullNamePtLen']" v-model="pdmCertInfoList.identFullNamePt" id="identFullNamePt" class="form-control" type="text" :placeholder="pdmI18NList.identFullNamePt">
            </div>
        </div>
        ...
        <div class="form-group" v-bind:class="{ hide: isHidePrint }">
            <label class="control-label col-sm-1_5" v-text="pdmI18NList.printLastNamePtAndFirstNamePt">列印葡文姓/名 -t</label>
            <div class="col-sm-4">
                <div class="input-group">
                    <input @input="printPtNameBlur('printLastNamePt')" @blur="printPtNameBlur('printLastNamePt',true)" v-bind:maxlength="pdmnameparammap['dlsPdmPrLastNamePtLen']" class="form-control" type="text" id="printLastNamePt" :placeholder="pdmI18NList.printLastNamePt" style="background-color: #fff;" v-model="pdmCertInfoList.printLastNamePt">
                    <span class="input-group-addon">/</span>
                    <input @input="printPtNameBlur('printFirstNamePt')" @blur="printPtNameBlur('printFirstNamePt',true)" v-bind:maxlength="pdmnameparammap['dlsPdmPrFirstNamePtLen']" class="form-control" type="text" id="printFirstNamePt" :placeholder="pdmI18NList.printFirstNamePt" style="background-color: #fff;" v-model="pdmCertInfoList.printFirstNamePt">
                </div>
            </div>
            <label class="control-label col-sm-1_5" v-text="pdmI18NList.printFullNamePt">列印葡文全名 -t</label>
            <div class="col-sm-4">
                <input @input="printPtNameBlur('printFullNamePt')" @blur="printPtNameBlur('printFullNamePt',true)" v-bind:maxlength="pdmnameparammap['dlsPdmPrFullNamePtLen']" class="form-control" id="printFullNamePt" type="text" :placeholder="pdmI18NList.printFullNamePt" style="background-color: #fff;" v-model="pdmCertInfoList.printFullNamePt">
            </div>
        </div>
    ...
    var pdmCertInfo = Vue.extend({
        ...
        methods:{
            nameBlur : function(nameId,blur){ 
                ...
                var dlsPdmIdFullNamePtLen = this.pdmnameparammap['dlsPdmIdFullNamePtLen'];//葡文全名的最大長度
                var dlsPdmPrFullNameCnLen = this.pdmnameparammap['dlsPdmPrFullNameCnLen'];//列印中文全名的最大長度
                var dlsPdmPrFullNamePtLen = this.pdmnameparammap['dlsPdmPrFullNamePtLen'];//列印葡文全名的最大長度
                ...
                if(nameId=='identLastNamePt'){
                    //this.pdmCertInfoList.identLastNamePt = this.pdmCertInfoList.identLastNamePt.trim();
                    //debugger;

                    var str = "";
                    str = this.pdmCertInfoList.identLastNamePt;

                    if(blur===true){
                        str = this.pdmCertInfoList.identLastNamePt.trim();
                    }

                    //var str = this.pdmCertInfoList.identLastNamePt.trim();
                    var temp = '';
                    ...
                    this.pdmCertInfoList.identLastNamePt = temp.toUpperCase();




                    $('#identLastNamePt').val(this.pdmCertInfoList.identLastNamePt);//用于触发校验
                    var length = this.pdmCertInfoList.identLastNamePt.length;
                    if(useValidator){
                        if(length>=dlsPdmIdColorChangePt){
                            $('#identLastNamePt').css('border-color','orange');
                        }else{
                            $('#identLastNamePt').css('border-color','');
                        }
                    }
                    ...
                    if(!useValidator){
                        if(length>=dlsPdmIdColorChangePt){
                            ...
                            $('#identLastNamePt').css('border-color','#ccc');
                        }
                    }

                    if(ptNamePatt.test(this.pdmCertInfoList.identLastNamePt)){
                        $.alert({
                            text: '葡文姓含有空格！'
                        });
                    }
                ...
                if(nameId=='identFirstNamePt'){
                    ...
                    var str = "";
                    str = this.pdmCertInfoList.identFirstNamePt;

                    if(blur===true){
                        str = this.pdmCertInfoList.identFirstNamePt.trim();
                    }
                    ...
                    this.pdmCertInfoList.identFirstNamePt = temp.toUpperCase();



                    $('#identFirstNamePt').val(this.pdmCertInfoList.identFirstNamePt);//用于触发校验
                    var length = this.pdmCertInfoList.identFirstNamePt.length;
                    if(useValidator){
                        if(length>=dlsPdmIdColorChangePt){
                            $('#identFirstNamePt').css('border-color','orange');
                        }else{
                            $('#identFirstNamePt').css('border-color','');
                        }
                    }
                    ...
                    if(!useValidator){
                        if(length>=dlsPdmIdColorChangePt){
                            ...
                            $('#identFirstNamePt').css('border-color','#ccc');
                        }
                    }

                    if(ptNamePatt.test(this.pdmCertInfoList.identFirstNamePt)){
                        $.alert({
                            text: '葡文名含有空格！'
                        });
                    }
                ...
                if(nameId=='identLastNamePt'||nameId=='identFirstNamePt'){
                    var length = this.pdmCertInfoList.identLastNamePt.trim().length + this.pdmCertInfoList.identFirstNamePt.trim().length;
                    if(length>0&&length<=dlsPdmIdFullNamePtLen){
                        if(this.pdmCertInfoList.identLastNamePt.trim().length>0&&this.pdmCertInfoList.identFirstNamePt.trim().length>0){
                            this.pdmCertInfoList.identFullNamePt = this.pdmCertInfoList.identLastNamePt.trim() +" "+ this.pdmCertInfoList.identFirstNamePt.trim();
                        }else{
                            this.pdmCertInfoList.identFullNamePt = this.pdmCertInfoList.identLastNamePt.trim() + this.pdmCertInfoList.identFirstNamePt.trim();
                        }
                    ...
                    if(length==0){
                        this.pdmCertInfoList.identFullNamePt = "";
                    }

                     $('#identFullNamePt').val(this.pdmCertInfoList.identFullNamePt);//用于触发校验

                    if(useValidator){
                        if(length>=dlsPdmIdColorChangePt){
                            $('#identFullNamePt').css('border-color','orange');
                        }else{
                            $('#identFullNamePt').css('border-color','');
                        }
                    }
                    ...
                    if(!useValidator){
                        if(length>=dlsPdmIdColorChangePt){
                            ...
                            $('#identFullNamePt').css('border-color','#ccc');
                        }
                    }
                }
                ...
                if(nameId=='identFullNamePt'){
                    //this.pdmCertInfoList.identFullNamePt = this.pdmCertInfoList.identFullNamePt.trim();
                    var str = "";
                    str = this.pdmCertInfoList.identFullNamePt;

                    if(blur===true){
                        str = this.pdmCertInfoList.identFullNamePt.trim();
                    }
                    ...
                    this.pdmCertInfoList.identFullNamePt = temp.toUpperCase();



                    $('#identFullNamePt').val(this.pdmCertInfoList.identFullNamePt);//用于触发校验
                    var length = this.pdmCertInfoList.identFullNamePt.length;
                    if(useValidator){
                        if(length>=dlsPdmIdColorChangePt){
                            $('#identFullNamePt').css('border-color','orange');
                        }else{
                    ...
                    if(ptNamePatt.test(this.pdmCertInfoList.identFullNamePt)){
                        $.alert({
                            text: '葡文全名含有空格！'
                        });
                    }
            ...
            printPtNameBlur : function(nameId,blur){ 
                //列印葡文姓
                if(nameId=='printLastNamePt'){
                    var str = "";
                    str = this.pdmCertInfoList.printLastNamePt;

                    if(blur===true){
                        str = this.pdmCertInfoList.printLastNamePt.trim();
                    }
                    ...
                    this.pdmCertInfoList.printLastNamePt = temp.toUpperCase();
                    $('#printLastNamePt').val(this.pdmCertInfoList.printLastNamePt).trigger('change');
                }

                //列印葡文名

                 if(nameId=='printFirstNamePt'){
                    var str = "";
                    str = this.pdmCertInfoList.printFirstNamePt;

                    if(blur===true){
                        str = this.pdmCertInfoList.printFirstNamePt.trim();
                    }
                    var temp = '';
                    for (var i = 0; i < str.length; i++) {
                        if (!str[i].match(/[\uff00-\uffff]/)) {
                    ...
                    this.pdmCertInfoList.printFirstNamePt = temp.toUpperCase();
                    $('#printFirstNamePt').val(this.pdmCertInfoList.printFirstNamePt).trigger('change');
                }


                //列印葡文全名
                if(nameId=='printFullNamePt'){
                    var str = "";
                    str = this.pdmCertInfoList.printFullNamePt;

                    if(blur===true){
                        str = this.pdmCertInfoList.printFullNamePt.trim();
                    }
                    ...
                    this.pdmCertInfoList.printFullNamePt = temp.toUpperCase();
                    $('#printFullNamePt').val(this.pdmCertInfoList.printFullNamePt).trigger('change');
                }
            },
            //授權修改列印名
            ...
            ok : function(){
                ...
                var dlsPdmPrLastNamePtLen = this.pdmnameparammap['dlsPdmPrLastNamePtLen'];//列印葡文姓的最大长度
                var dlsPdmPrFirstNamePtLen = this.pdmnameparammap['dlsPdmPrFirstNamePtLen'];//列印葡文名的最大长度
                var dlsPdmPrFullNamePtLen = this.pdmnameparammap['dlsPdmPrFullNamePtLen'];//列印葡文全名的最大長度
                ...
                //葡文姓
                if(atosUtil.isNotEmpty(this.pdmCertInfoList.identLastNamePt)){
                    if(this.pdmCertInfoList.identLastNamePt.length<=dlsPdmPrLastNamePtLen){
                        this.pdmCertInfoList.printLastNamePt  = this.pdmCertInfoList.identLastNamePt;  
                    }else{
                        this.pdmCertInfoList.printLastNamePt  = new String(this.pdmCertInfoList.identLastNamePt).substring(0,dlsPdmPrLastNamePtLen);  
                    }
                }

                //葡文名
                if(atosUtil.isNotEmpty(this.pdmCertInfoList.identFirstNamePt)){
                    if(this.pdmCertInfoList.identFirstNamePt.length<=dlsPdmPrFirstNamePtLen){
                        this.pdmCertInfoList.printFirstNamePt  = this.pdmCertInfoList.identFirstNamePt;  
                    }else{
                        this.pdmCertInfoList.printFirstNamePt  = new String(this.pdmCertInfoList.identFirstNamePt).substring(0,dlsPdmPrFirstNamePtLen);  
                    }
                }
                
                this.pdmCertInfoList.printFullNamePt = "";
                if(atosUtil.isNotEmpty(this.pdmCertInfoList.printLastNamePt)){
                    this.pdmCertInfoList.printFullNamePt += this.pdmCertInfoList.printLastNamePt;
                }
                
                if(atosUtil.isNotEmpty(this.pdmCertInfoList.printFirstNamePt)){
                    if(atosUtil.isNotEmpty(this.pdmCertInfoList.printFullNamePt)){
                        this.pdmCertInfoList.printFullNamePt += " "+this.pdmCertInfoList.printFirstNamePt;
                    }else{
                        this.pdmCertInfoList.printFullNamePt += this.pdmCertInfoList.printFirstNamePt;
                    }
                }    
            ...
            initEvent:function(){
             function dateCompare(currentDate1,currentDate2,currentMonth1,currentMonth2,currentYear1,currentYear2){//兩個日期比較大小
                ...
                $('#identLastNamePt,#identFirstNamePt').on('input',function(){
                    ...
                    var identFullNameLength = $('#identLastNamePt').val().length + $('#identFirstNamePt').val().length;
                    if(identFullNameLength<=dlsPdmIdFullNamePtLen){
                        if($('#identLastNamePt').val().length == 0){
                            $('#identFullNamePt').val($("#identLastNamePt").val()+""+$("#identFirstNamePt").val()).trigger('input');
                            self.pdmCertInfoList.identFullNamePt = $("#identLastNamePt").val()+""+$("#identFirstNamePt").val();  
                        }else{
                            $('#identFullNamePt').val($("#identLastNamePt").val()+" "+$("#identFirstNamePt").val()).trigger('input');
                            self.pdmCertInfoList.identFullNamePt = $("#identLastNamePt").val()+" "+$("#identFirstNamePt").val();  
                        }
                        //$('#identFullNamePt').val($("#identLastNamePt").val()+" "+$("#identFirstNamePt").val());
                        //self.pdmCertInfoList.identFullNamePt = $("#identLastNamePt").val()+" "+$("#identFirstNamePt").val();  
                    }
                ...
                $('#identFullNamePt').on('input',function(){
                    var length = $(this).val().length;
                    if(useValidator){
                        if($('#fm-ident').data('bootstrapValidator')!=undefined){
                            $('#fm-ident').data('bootstrapValidator')
                ...
                $('#printLastNamePt,#printFirstNamePt').on('input',function(){//葡文姓名改變
                    var identFullNameLength = $('#printLastNamePt').val().length + $('#printFirstNamePt').val().length + 1;
                    if($('#printLastNamePt').val()!=''){
                        if(identFullNameLength<=dlsPdmPrFullNamePtLen){
                            $('#printFullNamePt').val($("#printLastNamePt").val().toUpperCase()+" "+$("#printFirstNamePt").val().toUpperCase());
                            self.pdmCertInfoList.printFullNamePt = $("#printLastNamePt").val().toUpperCase()+" "+$("#printFirstNamePt").val().toUpperCase();
                        }
                    }else{
                        if(identFullNameLength<=dlsPdmPrFullNamePtLen){
                            $('#printFullNamePt').val($("#printLastNamePt").val().toUpperCase()+""+$("#printFirstNamePt").val().toUpperCase());
                ...
                $("#paste").click(function(){//讀取智能身份證
                    try {
                        ...
                        */
                        ...
                        /**
                         *讀取證件信息的數據源里firstPtName表示姓，我們這邊identLastNamePt表示姓
                         *這裡對應的關係   
                        */
                        self.pdmCertInfoList.identLastNamePt = smartcard.firstPtName;
                        self.nameBlur('identLastNamePt');
                        self.pdmCertInfoList.identFirstNamePt = smartcard.lastPtName;
                        self.nameBlur('identFirstNamePt');


                        if(atosUtil.isNotEmpty(smartcard.clientName_pt)){
                            var afterTrim = smartcard.clientName_pt.trim();
                            if(afterTrim.length>0){
                                self.pdmCertInfoList.identFullNamePt = smartcard. clientName_pt;
                                self.nameBlur('identFullNamePt');
                            }
                        }
                                ...
                                validators: {
                                    callback:{
                                        callback:function(value,validator){
                                            ...
                                            var lastNamePtValidator = atosUtil.isNotEmpty($('#identLastNamePt').val());
                                            var firstNamePtValidator = atosUtil.isNotEmpty($('#identFirstNamePt').val());
                                            var fullNamePtValidator = atosUtil.isNotEmpty($('#identFullNamePt').val());
                                            if(lastNameCnValidator||firstNameCnValidator||fullNameCnValidator||lastNamePtValidator||firstNamePtValidator||fullNamePtValidator){
                                                return true;
                                            }else{
                                                message="請填寫必填欄位";
                                                return false;
