                                ...
                                <tr>
                                    ...
                                    <th>
                                        ...
                                        <div class="text-muted">
                                            <span v-text="pdmI18NList.fullNamePt">葡文全名</span>
                                        </div>
                                    </th>
                                    <th>
        ...
        data:function(){
            return {
                ...
                pdmI18NList:{
                    ...
                    fullNamePt:atosUtil.getI18nMessage('pdm.fullNamePt'),
                    ...
                    columns:[
                        ...
                        },
                        {
                            ...
                            "render": function ( data, type, row,   meta ) {
                                ...
                                var printFullNamePt = row.printFullNamePt;//葡文列印名
                                if(printFullNameCn!='')
                                    printFullNameCn = '('+printFullNameCn+')';
                                if(printFullNamePt!='')
                                    printFullNamePt = '('+printFullNamePt+')';
                                return '<div style="cursor:pointer;">'+data+printFullNameCn+'<br/><span class="text text-muted">'+row.identFullNamePt+printFullNamePt+'</span></div>';
                            },
                            width : 'auto'
                        }, 
                        {
