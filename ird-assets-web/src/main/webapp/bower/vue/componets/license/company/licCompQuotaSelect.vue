                ...
                loadData:function () {
                    ...
                    if (self.comp){
                        ...
                        if (self.comp.licPecComp) {
                            ...
                            lastSavedComp.comp.compNameDesc =  self.getCompDesc(lastSavedComp.comp.compIdentType,lastSavedComp.comp.compIdentNo,lastSavedComp.comp.compPname,lastSavedComp.comp.compCname);
