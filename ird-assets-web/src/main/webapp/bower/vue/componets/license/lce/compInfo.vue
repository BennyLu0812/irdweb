  ...
  <div v-show="show">
    <div>
        ...
        <div class="form-group">
            ...
            <label class="control-label col-sm-1">{{label.compPname}}</label>
            <div class="col-sm-6_5">
                <span class="text-readonly" v-text="comp.compPname"><br></span>
            </div>
        </div>
		 ...
		 props: {
            ...
            methods:{
                initData:function(){
                    ...
                    this.label.compPname= atosUtil.getI18nMessage('comp.compPname');                    
